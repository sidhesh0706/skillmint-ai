          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ...
              return (
                <article
                  key={item.title}
                  className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-line sm:p-6"
                >
            ...
            <div className="grid gap-0 lg:grid-cols-[0.7fr_0.3fr]">
              <div className="p-6 sm:p-8">
                ...
                <h2 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-ink">
                  Early-career experience is often stronger than it sounds at
                  first.
                </h2>
                <p className="mt-3 leading-7 text-slate-600">
                  Most early-career applicants have useful experience, but it
                  often lives in messy notes, class projects, internship tasks,
                  or part-time work that does not sound strong on a resume yet.
                  SkillMint is designed to bridge that gap with focused tools
                  instead of a generic blank chat box.
                </p>
              ...
              <div className="border-t border-slate-200 bg-[#FAFAF8] p-6 sm:p-8 lg:border-l lg:border-t-0">
                ...
                <div className="mt-4 grid gap-2 text-sm font-semibold text-slate-700">
                  {["Students", "Freshers", "Interns", "Career switchers"].map(
                    (item) => (
                      <span
                        key={item}
