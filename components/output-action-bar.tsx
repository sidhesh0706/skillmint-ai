...
export function OutputActionBar({ actions }: OutputActionBarProps) {
  return (
    <div className="sticky bottom-3 z-20 rounded-[1.5rem] border border-slate-200 bg-white/[0.9] p-2 shadow-[0_22px_80px_rgba(23,32,51,0.18)] backdrop-blur-xl sm:rounded-full">
