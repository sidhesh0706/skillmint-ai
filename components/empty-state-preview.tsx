...
export function EmptyStatePreview({
  ...
  return (
    <div className="empty-state-shell relative flex flex-1 items-center justify-center overflow-hidden rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(135deg,#ffffff,#fbfcfb_48%,#eef8f4)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.96)] sm:p-6">
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="empty-state-preview-card mt-5 rounded-[1.35rem] border border-slate-200 bg-white/95 p-4 text-left shadow-[0_20px_64px_rgba(8,11,18,0.09)] backdrop-blur">
